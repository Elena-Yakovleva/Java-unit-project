...
public class DeliveryCardServiceTestV2 {
    ...
    //java -jar ./artifacts/app-card-delivery.jar -port=8080
    ...
    void shouldSelectCityFromList() {
        ...
        Selenide.open("http://localhost:8080");// открыть страницу
    ...
    void shouldSelectDataFromCalendar( ) {
        ...
        int daysToMeeting = 7; // через сколько дней планируется встреча
